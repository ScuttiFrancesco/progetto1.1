...
// ==========================================
// Configurazione admin panel Strapi con funzionalità Preview integrata.
//
// Features:
// 1. Preview Mode:
//    - Integrazione con frontend per preview contenuti (draft/published)
//    - URL dinamici basati su content-type (pagine, comunicati-stampa, eventi, news, etc.)
//    - Secret key per validazione richieste preview
//    - Supporto iframe con allowedOrigins configurabili
//
// 2. Content-types supportati per preview:
//    - api::page-config.page-config -> /preview?slug={slug}
//    - api::comunicati-stampa.comunicati-stampa -> /in-vostro-aiuto/informazioni/comunicati-stampa/{slug}
//    - api::eventi.eventi -> /in-vostro-aiuto/informazioni/eventi/{slug}
//    - api::news.news -> /in-vostro-aiuto/informazioni/news/{slug}
//    - api::ordine-del-giorno.ordine-del-giorno -> /chi-siamo/oggi/il-comandante-generale/ordine-del-giorno/{slug}
//
// 3. Security:
//    - JWT secret per autenticazione admin
//    - API token salt per generazione token sicuri
//    - Transfer token salt per data transfer
